...
<div id="s-bottom-layer-right" class="s-bottom-layer-right" style="position:fixed; bottom:5%; left:37%">
    <p style="color: #4b5257">Copyright ©2020 testrunner.cn All Rights Reserved |
        <a style="color: #4b5257" href='http://beian.miit.gov.cn' target='_blank'>京ICP备20002884号-1</a>
    </p><br>
